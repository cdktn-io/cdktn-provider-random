...
// https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/uuid4
...
export class Uuid4 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Uuid4 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/uuid4#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/uuid4 random_uuid4} Resource
  *
  * @param scope The scope in which to define this construct
