...
// https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/id
...
export class Id extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Id that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/id#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/id random_id} Resource
  *
  * @param scope The scope in which to define this construct
