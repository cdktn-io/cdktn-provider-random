...
// https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/ephemeral-resources/password
...
*/
export class EphemeralRandomPassword extends cdktn.TerraformEphemeralResource {
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/ephemeral-resources/password random_password} Ephemeral Resource
  *
  * @param scope The scope in which to define this construct
  * @param id The scoped construct ID. Must be unique amongst siblings in the same scope
  * @param options EphemeralRandomPasswordConfig
  */
  public constructor(scope: Construct, id: string, config: EphemeralRandomPasswordConfig) {
    super(scope, id, {
