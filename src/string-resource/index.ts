...
// https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/string
...
export class StringResource extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing StringResource that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/string#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/hashicorp/random/3.9.1/docs/resources/string random_string} Resource
  *
  * @param scope The scope in which to define this construct
